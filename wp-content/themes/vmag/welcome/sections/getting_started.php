<div class="theme-steps-list">
	...
	<div class="theme-steps">
		<h3><?php echo esc_html__('Step 1 - Recommended Actions', 'vmag'); ?></h3>
		...
		<a class="button" href="<?php echo esc_url(admin_url('/themes.php?page=vmag-welcome&section=import_demo')); ?>"><?php echo esc_html__('Recommended Actions', 'vmag'); ?></a>
	</div>
