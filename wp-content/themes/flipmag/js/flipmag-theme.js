...
var Flipmag_Theme = (function($) {
	...
	return {
		...
		{   
			 ...
			 */
			$('.main img, .main-footer img, .main-featured .row').addClass('no-display');
			
			$('.main img, .main-footer img, .main-featured .row').one('inview', function() {
				$( this ).parent('a').siblings('.loader-img').remove();
				$( this ).siblings('.loader-img').remove();
				$( this ).siblings('span').addClass('appear');
        ...
        sticky_sidebar:function()
		{
            ...
            $('aside.sidebar ').stick_in_parent({parent: '.row'});
        },
			...
			var sticky = function() {
				...
				if ($(window).scrollTop() > nav_top) {
					...
					if (!nav.hasClass('sticky')) {
						...
						if( nav_wrap.length && nav_wrap.data('wrap').length ){
							nav_wrap.removeClass('wrap'); 
						}
