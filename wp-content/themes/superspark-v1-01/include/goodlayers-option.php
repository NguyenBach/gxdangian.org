	...
	*/
	...
	$goodlayers_menu = array(			
		...
		__('Overall Elements', 'gdl_back_office') => array(
			...
			__('Top Slider Setting', 'gdl_back_office')=>'gdl_panel_top_slider_setting'),
	...
	$goodlayers_element = array(
		...
		'gdl_panel_search_archive_style' => array(
			...
			__('SEARCH/ARCHIVE ITEM SIZE', 'gdl_back_office')=>array(
				...
				'options'=>array('1/4 Blog Widget', '1/3 Blog Widget', '1/2 Blog Widget', '1/1 Blog Widget', 
								 '1/1 Medium Thumbnail', '1/1 Full Thumbnail', '1/1 Blog Modern')
			),	
			__('SEARCH/ARCHIVE SHOW BLOG WIDGET DATE', 'gdl_back_office')=>array(
				'type'=>'combobox',
				'name'=>THEME_SHORT_NAME.'_search_archive_show_blog_widget_date',
				'options'=>array('Yes', 'No')
			),				
		...
		'gdl_panel_font_size' => array(
			...
			__('WIDGET TITLE SIZE', 'gdl_back_office')=>array('type'=>'sliderbar','name'=>THEME_SHORT_NAME.'_widget_title_size','default'=>'13',
		...
		'gdl_panel_font' => array(
			__('HEADER FONT', 'gdl_back_office')=>array('type'=>'font-combobox','name'=>THEME_SHORT_NAME.'_header_font', 'default'=>'- Open Sans',
			...
			__('MAIN NAVIGATION FONT', 'gdl_back_office')=>array('type'=>'font-combobox','name'=>THEME_SHORT_NAME.'_navigation_font', 'default'=>'- Merriweather'),
		...
		'gdl_panel_logo' => array( 
			__('TOP BAR LEFT TEXT', 'gdl_back_office')=>array('type'=>'textarea','name'=>THEME_SHORT_NAME.'_top_navigation_left_text'),		
			__('LOGO', 'gdl_back_office')=>array('type'=>'upload','name'=>THEME_SHORT_NAME.'_logo'), 
			__('LOGO TOP MARGIN', 'gdl_back_office')=>array('type'=>'inputtext','name'=>THEME_SHORT_NAME.'_logo_top_margin','default'=>'45',
				'description'=>'Input number to set the top space of the logo. Negative value is allowed. Please use -0 instead of 0.'), 
			__('LOGO BOTTOM MARGIN', 'gdl_back_office')=>array('type'=>'inputtext','name'=>THEME_SHORT_NAME.'_logo_bottom_margin','default'=>'35',
				'description'=>'Input number to set the bottom space of the logo. Negative value is allowed. Please use -0 instead of 0.'),		
			__('NAVIGATION TOP MARGIN', 'gdl_back_office')=>array('type'=>'inputtext','name'=>THEME_SHORT_NAME.'_navigation_top_margin','default'=>'56'), 				 				
		),

		'gdl_panel_icon_style' => array(		
			__('SOCIAL NETWORK ICON STYLE','gdl_back_office')=>array( 'type'=>'combobox', 'name'=>THEME_SHORT_NAME.'_social_network_icon_type', 'options'=>array('1'=>'light','2'=>'dark'),
			...
			__('BODY ICON STYLE','gdl_back_office')=>array( 'type'=>'combobox', 'name'=>THEME_SHORT_NAME.'_icon_type', 'options'=>array('1'=>'dark','2'=>'light'),
				'description'=>'This option will change all of the icon in this theme( except from footer ) to be dark/light version.'),	
			__('PORTFOLIO HOVER ICON','gdl_back_office')=>array( 'type'=>'combobox', 'name'=>THEME_SHORT_NAME.'_portfolio_hover_icon', 'options'=>array('1'=>'light','2'=>'dark')),						
		...
		'gdl_panel_top_slider_setting' => array(
			__('TOP SLIDER MAX WIDTH', 'gdl_back_office')=>array('type'=>'inputtext','name'=>THEME_SHORT_NAME.'_top_slider_max_width','default'=>'1200',
				'The value should be match with the slider width you set at the Layer slider setting'),
			__('TOP SLIDER BACKGROUND PATTERN', 'gdl_back_office')=>array('type'=>'radioenabled','name'=>THEME_SHORT_NAME.'_top_slider_bg_pattern'),
		),
		...
		'gdl_panel_header_navigation' => array(
			__('TOP BAR BACKGROUND', 'gdl_back_office')=>array( 'type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_top_bar_background',
				'default'=>'#fcc71f', 'attr'=> array('background-color'), 'selector'=>'.top-navigation-wrapper' ),
			__('TOP BAR TEXT COLOR', 'gdl_back_office')=>array( 'type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_top_bar_text',
				'default'=>'#ffffff', 'attr'=> array('color'), 'selector'=>'.top-navigation-wrapper, .top-navigation-wrapper a' ),			
			__('MAIN NAVIGATION TEXT', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_main_navigation_text',
				'default'=>'#686868', 'attr'=> array('color'), 'selector'=>'.sf-menu li a',
			...
			__('MAIN NAVIGATION TEXT HOVER', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_main_navigation_text_hover',
				'default'=>'#adadad', 'attr'=> array('color'),  'selector'=>'.sf-menu li a:hover',
			...
			__('MAIN NAVIGATION TEXT CURRENT', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_main_navigation_text_current',
				'default'=>'#686868', 'attr'=> array('color'), 'selector'=>'.sf-menu li.current-menu-ancestor a, .sf-menu li.current-menu-item a',
				'description'=>'This is the text color of the main navigation in "current page" state.'),
			__('MAIN NAVIGATION TEXT CURRENT LEFT BAR', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_main_navigation_text_current_left_bar',
				'default'=>'#fcc71f', 'attr'=> array('border-left-color'), 'selector'=>'ul.sf-menu li.current-menu-ancestor a, ul.sf-menu li.current-menu-item a, ul.sf-menu li a:hover'),				
			__('SUB NAVIGATION BACKGROUND', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_sub_navigation_background',
				'default'=>'#f7f7f7', 'attr'=> array('background-color'), 'selector'=>'.sf-menu li li' ),
			__('SUB NAVIGATION BORDER', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_sub_navigation_border',
				'default'=>'#e5e5e5', 'attr'=> array('border-color'), 'selector'=>'.sf-menu ul, .sf-menu ul li' ),
			...
			__('SUB NAVIGATION TEXT HOVER', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_sub_navigation_text_hover',
				'default'=>'#383838', 'attr'=> array('color'), 
		...
		'gdl_panel_body' => array(	
			__('PAGE HEADER TITLE BACKGROUND', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_page_header_background',
				'default'=>'#f6f6f6', 'attr'=>array('background-color'), 'selector'=>'div.page-header-wrapper'),			
			__('PAGE HEADER TITLE BOTTOM BORDER', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_page_header_bottom_border',
				'default'=>'#fcc71f', 'attr'=>array('border-color'), 'selector'=>'div.page-header-wrapper'),		
			__('PAGE HEADER TITLE COLOR', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_page_header_title_color',
				'default'=>'#4e4e4e', 'attr'=>array('color'), 'selector'=>'h1.page-header-title'),	
			__('PAGE HEADER CAPTION', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_page_header_caption',
				'default'=>'#a8a8a8', 'attr'=>array('color'), 'selector'=>'span.page-header-caption'),				
			...
			__('CONTENT COLOR', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_content_color',
				'default'=>'#848484', 'attr'=>array('color'), 'selector'=>'body'),
			...
			__('LINK COLOR', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_link_color',
				'default'=>'#fcc71f', 'attr'=>array('color'), 'selector'=>'a',
			...
			__('LINK HOVER COLOR', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_link_hover_color',
				'default'=>'#fcdf8f', 'attr'=>array('color'), 'selector'=>'a:hover',
		...
		'gdl_panel_sidebar_color' => array(
			__('SIDEBAR LINK COLOR', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_sidebar_link_color',
				'default'=>'#3d3d3d', 'attr'=>array('color'), 'selector'=>'.sidebar-wrapper a' ),
			...
			__('SIDEBAR TITLE BOTTOM BAR', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_sidebar_title_bottom_bar',
				'default'=>'#d3d3d3', 'attr'=>array('border-color'), 'selector'=>'div.custom-sidebar-gimmick' ),
		...
		'gdl_panel_footer' => array(	
			__('FOOTER TOP BAR', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_footer_top_bar',
				'default'=>'#fcc71f', 'attr'=>array('background-color'), 'selector'=>'div.footer-top-bar',
			...
			__('COPYRIGHT TOP BORDER', 'gdl_back_office') => array('type'=>'colorpicker', 'name'=>THEME_SHORT_NAME.'_copyright_top_border', 
				'default'=>'#d2a721', 'attr'=>array('border-color'), 'selector'=>'div.footer-wrapper .copyright-outer-wrapper'),
		...
		'gdl_panel_slider' => array(
			__('TOP SLIDER BACKGROUND', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_top_slider_background',
				'default'=>'#474747', 'attr'=>array('background-color'), 'selector'=>'.gdl-top-slider-wrapper' ),		
			__('TOP SLIDER BOTTOM BAR', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_top_slider_bottom_bar',
				'default'=>'#fcc71f', 'attr'=>array('border-bottom-color'), 'selector'=>'body .gdl-top-slider-wrapper' ),	
			__('TOP SLIDER NAVIGATION BACKGROUND', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_slider_navigation_background',
				'default'=>'#373737', 'attr'=>array('background-color'), 
				'selector'=>'.ls-superspark .ls-nav-prev, .ls-superspark .ls-nav-next,' . 
							...
							'div.gdl-top-slider .anythingSlider .arrow.back, div.gdl-top-slider .anythingSlider .arrow.forward'),		
			__('TOP SLIDER NAVIGATION HOVER BACKGROUND', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_slider_navigation_active_background',
				'default'=>'#000000', 'attr'=>array('background-color'), 
				'selector'=>'.ls-superspark .ls-nav-prev:hover, .ls-superspark .ls-nav-next:hover, ' . 
							...
							'div.gdl-top-slider .anythingSlider .arrow.back:hover, div.gdl-top-slider .anythingSlider .arrow.forward:hover'),				
			...
			__('SLIDER TITLE BACKGROUND', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_slider_title_background',
				'default'=>'#fcc71f', 'attr'=>array('background-color'), 'selector'=>'h2.gdl-slider-title'),
			...
			__('SLIDER BULLET BACKGROUND', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_slider_bullet_background',
				'default'=>'#fcc71f', 'attr'=>array('background'), 
				'selector'=>'.flex-control-nav, .nivo-controlNav, div.anythingSlider .anythingControls ul'),			
			__('SLIDER BULLET COLOR', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_slider_bullet_color',
				...
				'selector'=>'.flex-control-nav li a, .nivo-controlNav a, div.anythingSlider .anythingControls ul a'),
			...
			__('STUNNING TEXT TITLE COLOR', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_stunning_text_title_color',
				'default'=>'#1f1f1f', 'attr'=>array('color'), 'selector'=>'h1.stunning-text-title' ),
			__('STUNNING TEXT CAPTION COLOR', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_stunning_text_caption_color',
				'default'=>'#8a8a8a', 'attr'=>array('color'), 'selector'=>'.stunning-text-caption'),
			__('STUNNING TEXT BACKGROUND COLOR', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_stunning_text_background_color',
				'default'=>'#fafafa', 'attr'=>array('background-color'), 'selector'=>'.stunning-text-wrapper'),		
			__('STUNNING TEXT BORDER', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_stunning_text_left_border',
				'default'=>'#fcc71f', 'attr'=>array('border-left-color', 'border-right-color'), 'selector'=>'.stunning-text-wrapper'),
		),
		...
		'gdl_panel_blog_pagination' => array(			
			__('BLOG TITLE COLOR', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_post_title_color',
				'default'=>'#212121', 'attr'=>array('color'), 'selector'=>'h2.blog-title a, h1.blog-title a, div.portfolio-item .page-item-title a' ),
			...
			__('BLOG WIDGET TAG COLOR', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_post_widget_tag_text',
				'default'=>'#b6b6b6', 'attr'=>array('color'), 'selector'=>'div.gdl-blog-widget .blog-tag, div.gdl-blog-widget .blog-tag a'),		
			__('BLOG WIDGET DATE COLOR', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_post_widget_date_color',
				'default'=>'#444444', 'attr'=>array('color'), 'selector'=>'div.gdl-blog-widget .blog-date-wrapper'),
			__('BLOG WIDGET DATE BACKGROUND', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_post_widget_date_background',
				'default'=>'#f5f5f5', 'attr'=>array('background-color'), 'selector'=>'div.gdl-blog-widget .blog-date-wrapper'),
			__('BLOG MODERN DATE COLOR', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_post_modern_date_color',
				'default'=>'#ffffff', 'attr'=>array('color'), 'selector'=>'div.gdl-blog-modern .blog-date-wrapper, div.gdl-blog-list .blog-date-wrapper'),
			__('BLOG MODERN DATE BACKGROUND', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_post_modern_date_background',
				'default'=>'#fcc71f', 'attr'=>array('background-color'), 'selector'=>'div.gdl-blog-modern .blog-date-wrapper, div.gdl-blog-list .blog-date-wrapper'),				
			__('BLOG MODERN LIST BACKGROUND', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_post_modern_list_background',
				'default'=>'#f6f6f6', 'attr'=>array('background-color'), 'selector'=>'div.gdl-blog-list .blog-list-style'),
			__('BLOG INFO COLOR', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_post_info_color',
				'default'=>'#969696', 'attr'=>array('color'), 'selector'=>'div.blog-info-wrapper a'),
			__('BLOG INFO TITLE COLOR', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_post_info_title_color',
				'default'=>'#595959', 'attr'=>array('color'), 'selector'=>'div.blog-info-wrapper'),				
			...
			__('PAGINATION HOVER BACKGROUND', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_pagination_hover_background',
				'default'=>'#fcc71f', 'attr'=>array('background-color'), 'selector'=>'div.gdl-pagination a:hover'),
			...
			__('PAGINATION CURRENT BACKGROUND', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_pagination_current_background',
				'default'=>'#fcc71f', 'attr'=>array('background-color'), 'selector'=>'div.gdl-pagination span'),
		...
		'gdl_panel_portfolio' => array(
			__('THUMBNAIL HOVER COLOR', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_port_thumbnail_hover_color',
				'default'=>'#fcc91f', 'attr'=>array('background-color'), 'selector'=>'div.portfolio-media-wrapper .portfolio-thumbnail-image-hover'),					
			...
			__('PORT TITLE HOVER COLOR', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_port_title_hover_color',
				'default'=>'#ffffff', 'attr'=>array('color'), 'selector'=>'.portfolio-item .portfolio-context .portfolio-title a:hover'),
			__('PORT TAG COLOR', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_port_tag_color',
				'default'=>'#ffffff', 'attr'=>array('color'), 'selector'=>'.portfolio-item .portfolio-context .portfolio-tag a, .portfolio-item .portfolio-context .portfolio-tag'),	
			__('PORT TAG HOVER COLOR', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_port_tag_color',
			...
			__('PORT FILTER COLOR', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_port_filter_color',
				'default'=>'#767676', 'attr'=>array('color'), 'selector'=>'ul.portfolio-item-filter, ul.portfolio-item-filter li a'),
			__('PORT FILTER ACTIVE COLOR', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_port_filter_active_color',
				'default'=>'#fcc71f', 'attr'=>array('color'), 'selector'=>'ul.portfolio-item-filter li a.active'),				
			...
			__('VIEW ALL PORT/READ THE BOLOG TEXT', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_view_all_port_color',
				'default'=>'#333333', 'attr'=>array('color'), 'selector'=>'a.view-all-projects' )		
		),
		...
		'gdl_panel_price_personnal_item' => array(
			...
			__('PRICE TAG ACTIVE BACKGROUND', 'gdl_back_office') => array('type'=>'colorpicker', 'name'=>THEME_SHORT_NAME.'_price_tag_active_background', 
				'default'=>'#fcc71f', 'attr'=>array('background-color'), 'selector'=>'div.best-price .price-tag'),
			__('PRICE ACTIVE TOP BORDER', 'gdl_back_office') => array('type'=>'colorpicker', 'name'=>THEME_SHORT_NAME.'_price_active_border', 
				'default'=>'#fcc71f', 'attr'=>array('border-top-color', 'border-bottom-color'), 'selector'=>'div.best-active'),			
			__('PRICE ACTIVE BUTTON BACKGROUND', 'gdl_back_office') => array('type'=>'colorpicker', 'name'=>THEME_SHORT_NAME.'_price_active_button_background', 
				'default'=>'#fcc71f', 'attr'=>array('background-color'), 'selector'=>'div.price-item .price-button'),				
			...
			__('PERSONNAL THUMBNAIL BORDER', 'gdl_back_office') => array('type'=>'colorpicker', 'name'=>THEME_SHORT_NAME.'_personnal_thumbnail_border', 
				'default'=>'#fcc71f', 'attr'=>array('border-color'), 'selector'=>'div.personnal-item .personnal-thumbnail'),
		...
		'gdl_panel_additional_elements' => array(				
			...
			__('BUTTON BACKGROUND COLOR', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_button_background_color',
				'default'=>'#fcc71f', 'attr'=>array('background-color'), 'selector'=>'a.gdl-button, body button, input[type="submit"], input[type="reset"], input[type="button"]'),					
		...
		'gdl_panel_additional_elements_2' => array(
			...
			__('TAB ACTIVE TITLE BORDER', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_tab_active_title_border',
				'default'=>'#fcc71f', 'attr'=>array('border-top-color'), 'selector'=>'div.gdl-tab ul.gdl-tab-title li a.active' ),	
		...
		'gdl_panel_blog_port_translator' => array(
			...
			__('MORE BLOG FEED (BLOG)', 'gdl_back_office')=>array('type'=>'inputtext','name'=>THEME_SHORT_NAME.'_translator_more_blog_feed','default'=>'More Blog Feed'),
			...
			__('VIEW ALL PROJECTS (PORTFOLIO TITLE)', 'gdl_back_office')=>array('type'=>'inputtext','name'=>THEME_SHORT_NAME.'_translator_view_all_portfolio','default'=>'View All Projects'),			
