...
class td_api_newsletter {
    ...
    /**
     * For $param_name get the associated font mapped params (font-family, font-size, ..)
     *
     * @param $param_name - param for which fonts' params will be rendered
     * @param bool $font_header - add font header columns
     * @param string $font_title - title used for font params
     * @param string $group - group where font params will be rendered
     *
     * @return array
     */
    function get_font_group_params( $param_name, $font_header = false, $font_title = '', $group = '', $index_style = '' ) {

        $params = $this->group_params[ 'font' ];
    ...
    function tdn_on_register_shortcodes() { //add the api code inside this function
        ...
        $this->group_params = array_merge( $this->group_params, tdc_config::$group_params );
...
//                                    'AWeber'      => 'aweber',
    ...
    function register_styles() {
        ...
        $fonts = array_merge(
            ...
            $this->get_font_group_params( 'f_title', true, 'Title text', 'Style' ),
            $this->get_font_group_params( 'f_descr', false, 'Description text', 'Style' ),
            $this->get_font_group_params( 'f_disclaimer', false, 'Disclaimer text', 'Style' ),
            $this->get_font_group_params( 'f_input', false, 'Input bar text', 'Style' )
        );
