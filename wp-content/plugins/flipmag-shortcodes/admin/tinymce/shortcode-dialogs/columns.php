...
<p>
	<strong><?php _e('Pre-defined Examples:', 'flipmag-shortcodes'); ?></strong>
	<a href="#" class="predefined-cols" data-cols="3" data-val="1/3"><?php echo _e('Three equal columns', 'flipmag-shortcodes'); ?></a>, 
	<a href="#" class="predefined-cols" data-cols="4" data-val="1/4"><?php echo _e('Four equal columns', 'flipmag-shortcodes'); ?></a>,
	<a href="#" class="predefined-cols" data-cols="5" data-val="1/5"><?php echo _e('Five equal columns', 'flipmag-shortcodes'); ?></a>
</p>
 

<p><a href="#" id="add-more-groups"><?php _e('Add Another Column', 'flipmag-shortcodes'); ?></a></p>
...
<script type="text/html" class="template-group-options">
	...
	<div class="element-control">
		<label><?php _e('Size:', 'flipmag-shortcodes'); ?></label>
...
jQuery(function($) {
	...
	var predefined = function() {
		...
		$('#add-more-groups').parent().data('flipmag_tabs', 0);
