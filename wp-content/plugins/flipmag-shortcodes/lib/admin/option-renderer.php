...
class Flipmag_Admin_OptionRenderer
{
	...
	public function render_checkbox($element)
	{
		...
		$element['options'] = array_merge(
			array('checked' => __('Yes', 'so-widgets-bundle'), 'unchecked' => __('No', 'so-widgets-bundle')), 
	...
	{
		$button_label = __( 'Upload', 'so-widgets-bundle' );
		...
		{ 
			...
			$output .= '<div class="image-upload'. $classes .'">'. $image .'<a href="" class="remove-image">'. __('Remove', 'so-widgets-bundle') .'</a></div>';
		}
